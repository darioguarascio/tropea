...
//Array to disable the debugbar in each enabled country
// $deny_routes = array_map(function($e){return 'langAppJs@'.$e;}, app()->getConfig()->virail->enabledCountries->toArray());
...
return array(
	...
	'collectors' => array(
		...
		'phalcon_request' => false,  // Only one can be enabled..
